  ...
  return (
    <div
      ...
      className={`w-full h-fit ${
        orderBooks === null || orderBooks.length == 0 ? "hidden" : "flex"
      } flex-col mt-24 items-center gap-y-5`}
    >
      <span className="w-fit h-fit text-white text-2xl">
        ...
        <div className="w-fit h-fit flex flex-col gap-y-2">
          ...
          <div
            className={`w-full h-fit rounded-2xl p-3 bg-card backdrop-blur-sm ${
              fromCurr === undefined || toCurr === undefined ? "hidden" : ""
            }`}
          >
            <Table>
