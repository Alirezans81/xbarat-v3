...
export const useCreateCurrencyPair = () => {
  ...
  const fetch = ({
    ...
    checkTokenExpiration(async () => {
      await createCurrencyPair(token.value, currencyPair)
        .then((res) => {
          onSuccess?.(res);
        })
        .catch((err) => {
...
export const useUpdateCurrencyPair = () => {
  ...
  const fetch = ({
    ...
    checkTokenExpiration(async () => {
      await updateCurrencyPair(token.value, currencyPair_id, currencyPair)
        .then((res) => {
          onSuccess?.(res);
        })
        .catch((err) => {
...
export const useDeleteCurrencyPair = () => {
  ...
  const fetch = ({
    ...
    checkTokenExpiration(async () => {
      await deleteCurrencyPair(token.value, currencyPair_id)
        .then((res) => {
          onSuccess?.(res);
        })
        .catch((err) => {
